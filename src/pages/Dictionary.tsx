...
const dictionary = [
  ...
  { scn: 'Atturatu', es: 'Tostado', it: 'Tostato', en: 'Toasted' },
  { scn: 'Ava', es: 'Ahora', it: 'Adesso', en: 'Now' },
  ...
  { scn: 'Bona sira', es: 'Buenas tardes/noches', it: 'Buonasera', en: 'Good evening' },
  ...
  { scn: 'Compa\' / \'Mbare', es: 'Amigo / Compadre', it: 'Compare / Amico', en: 'Friend / Bro' },
  ...
  { scn: 'Palummedda', es: 'Palometa', it: 'Palombo', en: 'Dogfish' },
  ...
  { scn: 'Picciottu/a', es: 'Chico/a', it: 'Ragazzo/a', en: 'Boy/Girl' },
  ...
  { scn: 'Supra', es: 'Encima', it: 'Sopra', en: 'Above' },
