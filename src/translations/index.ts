export const translations = {
  es: {
    ...
    details: {
      ...
      schedule: {
        title: 'Programa',
        day0: 'Viernes 19 Junio 2026',
        day1: 'Sábado 20 Junio 2026',
        day1Event: '20:30 Preboda en Palacio de Congresos',
        ...
        busBack: '23:00/00:00 Autobús de vuelta a Ávila',
        items: {
          ...
          busBack: 'Autobús de vuelta a Ávila'
        }
      },
      transportation: {
        title: 'Transporte',
      ...
      sicilyFacts: {
        ...
        items: [
          ...
          },
          {
            ...
            content: 'Ni los propios sicilianos se ponen de acuerdo. En el este dicen "arancini", en el oeste "arancine". No importa cómo lo llames: están buenísimes.'
          },
          {
  ...
  scn: {
    ...
    about: {
      ...
      joinUs: 'Ora semu luntani, ma vaddamu sempri cu \'n\'occhiu l\'isula smeralda, cu tanti ricordi e \'na bedda nostalgia. Doppu amuri, risati e assai avventuri nzemi, semu pronti pi cuminciari \'stu novu capitulu comu maritu e mugghieri.'
    },
    venue: {
    ...
    story: {
      ...
      milestones: {
        firstMeet: {
          ...
          date: 'Giugnu 2020',
          description: 'I nostri strati s\'ncruciaru nta l\'isula virdi nta l\'astati dû 2020. Doppu u nostru primu appuntamentu nto parcu St.Stephen cu nu cannolu sicilianu, diventammu nseparàbbili'
        },
        firstTrip: {
        ...
        proposal: {
          title: 'A Pruposta',
          date: 'Giugnu 2025',
          description: 'Fernando apprufitta l\'occasioni nta a cilibrazzioni dû 5 anniversariu. Malgrado i nirvi, nta nu calutu spittaculari nti l\'autu di Puebla de Sanabria, si nnicò e titubannu, ci pruposi a Chiara. Fu nu mumentu idòneu e naspittatu pi Chiara.'
        }
      },
    ...
    details: {
      ...
      schedule: {
        title: 'Prugramma',
        day0: 'Venneri 19 Giugnu 2026',
        day1: 'Sabbatù 20 Giugnu 2026',
        day1Event: '20:30 Festa prima du fistino a',
        day1Venue: 'Lienzo Norte',
        day1Description: ' ',
        ...
        busBack: '23:00/00:00 Autobùs pi turnari a Ávila',
        items: {
          ...
          busBack: 'Autobùs pi turnari a Ávila'
        }
      },
      attire: {
    ...
    faq: {
      ...
      items: {
        rsvp: {
          ...
          answer: 'Sciamunitu!U tèrmini pi cunfirmari è passau, macari contattaci e circaremu di sistemàriti.'
        },
        weather: {
      ...
      sicilyFacts: {
        ...
        items: [
          ...
          {
            title: '🍝 Arancini o arancine?',
            content: 'Mancu li siciliani si mettunu d\'accordu! A livanti dicinu "arancini", a punenti "arancine". Comu si chiamunu? N\'casa finisci sutta l\'ogghiu e sutta i denti!'
          },
          {
  ...
  it: {
    ...
    details: {
      ...
      schedule: {
        title: 'Programma',
        day0: 'Venerdì 19 Giugno 2026',
        day1: 'Sabato 20 Giugno 2026',
        ...
        busBack: '23:00/00:00 Autobus di ritorno per Ávila',
        items: {
          ...
          busBack: 'Autobus di ritorno per Ávila'
        }
      },
      attire: {
    ...
    faq: {
      ...
      items: {
        rsvp: {
          ...
          answer: 'Il termine di conferma è passato, ma puoi comunque contattarci e cercheremo di trovarti una soluzione'
        },
        weather: {
  ...
  en: {
    ...
    details: {
      ...
      schedule: {
        title: 'Schedule',
        day0: 'Friday, June 19, 2026',
        day1: 'Saturday, June 20, 2026',
        ...
        busBack: '23:00/00:00 Bus pickup to Ávila',
        items: {
          busHop: 'Bus Hop In',
    ...
    faq: {
      ...
      items: {
        rsvp: {
          ...
          answer: 'The RSVP deadline has passed; however, you can still contact us and we will try to accommodate you'
        },
        weather: {
