                  ...
                  {detail.title === t.details.transportation.title ? (
                    ...
                    <div className="text-muted-foreground text-sm leading-relaxed">
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-3xl max-h-[90vh] p-0 overflow-hidden bg-transparent border-0 shadow-none flex items-center justify-center">
                          <img
                            src="https://shoepifystore.com/cdn/shop/products/image_f6e9b57a-708d-474d-883d-8cbbdf9f4f07.jpg?v=1623140698&width=2048"
                            alt={t.details.attire.heelProtectors}
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="max-w-3xl max-h-[90vh] p-0 overflow-hidden bg-transparent border-0 shadow-none flex items-center justify-center">
                          <img
                            src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTCi0cun4VK07LeSct79rY7IhKQFcSnzsGjl3FaXJg7gYfidS9pVXj132tMZyESZXZy-Y37ppax-zWGdQ6-xMk1qXXrTG-iPH-aH1qaL1ZiCjw3FRekUGmhNILl"
                            alt={t.details.attire.comfyShoes}
                            className="w-full h-auto max-h-[85vh] object-contain rounded-lg"
                          />
                        </DialogContent>
                      </Dialog>
